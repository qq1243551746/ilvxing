...
public abstract class BasePasswordEncoder implements PasswordEncoder {
	...
	/**
	 * Used by subclasses to extract the password and salt from a merged <code>String</code> created using {@link #mergePasswordAndSalt(String,Object,boolean)}.
	 * <p>
	 * The first element in the returned array is the password. The second element is the salt. The salt array element will always be present, even if no salt was found in the <code>mergedPasswordSalt</code> argument.
	 * </p>
	 *
	 ...
	 * </p>
	 * <p>
	 * A <code>null</code> can be passed to either method, and will be handled correctly. If the <code>salt</code> is <code>null</code> or empty, the resulting generated password will simply be the passed <code>password</code>. The <code>toString</code> method of the <code>salt</code> will be used
	 * to represent the salt.
	 * </p>
	 *
	 * @param password
