...
public class AliyunMessageUtil {
	...
	private static String accessKeyId = "LTAIxh3UMGeMRfxm";
	private static String accessKeySecret = "9DdKES38NuR5mVuvbXHfNcY3zvd0sm";
	...
	public static SendSmsResponse sendSms(String phoneNumbers, String code) throws ClientException {
		...
		// 必填:短信签名-可在短信控制台中找到
		request.setSignName("视食");
		// 必填:短信模板-可在短信控制台中找到
		request.setTemplateCode("SMS_151575067");
		// 设置参数
	...
	public static QuerySendDetailsResponse querySendDetails(String phoneNumber) throws ClientException {
		...
		System.out.println(querySendDetailsResponse.toString());
