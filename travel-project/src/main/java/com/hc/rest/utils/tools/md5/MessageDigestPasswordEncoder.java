 ...
 * <p>
 * This class can be used stand-alone, or one of the subclasses can be used for compatiblity and convenience. When using this class directly you must specify a <a href="http://java.sun.com/j2se/1.5.0/docs/guide/security/CryptoSpec.html#AppA"> Message Digest Algorithm</a> to use as a constructor arg.
 * <p>
 * The encoded password hash is normally returned as Hex (32 char) version of the hash bytes. Setting the <tt>encodeHashAsBase64</tt> property to <tt>true</tt> will cause the encoded pass to be returned as Base64 text, which will consume 24 characters. See
 ...
 * </pre>
 * <p>
 * If desired, the {@link #setIterations iterations} property can be set to enable "<a href="http://en.wikipedia.org/wiki/Key_strengthening">password stretching</a>" for the digest calculation.
 *
 * @author Ray Krueger
 * @author Luke Taylor
 * @since 1.0.1
...
public class MessageDigestPasswordEncoder extends BaseDigestPasswordEncoder {
	...
	public boolean isPasswordValid(String encPass, String rawPass, Object salt) {
        ...
        System.out.println("1-------"+encodePassword(encPass, salt));
        System.out.println("2-------"+encodePassword(rawPass, salt));
	 ...
	 *
	 * @param iterations
	 *            the number of iterations which will be executed on the hashed password/salt value. Defaults to 1.
	 */
